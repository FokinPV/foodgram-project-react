# Generated by Django 4.1.7 on 2023-03-22 22:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='tag',
            name='color',
            field=models.CharField(choices=[('#FFFFFF', 'white'), ('#000000', 'black'), ('#00B823', 'green'), ('#0400B8', 'blue'), ('#FF7E26', 'orange'), ('#B5E61D', 'olive'), ('#A349A4', 'purple')], max_length=7, verbose_name='Цвет в HEX'),
        ),
